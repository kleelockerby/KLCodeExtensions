...
{
    public partial class CodeLayoutToolWindowControl : UserControl
    {
        public CodeLayoutToolWindowControl()
        {
            this.InitializeComponent();
        }

        public CodeLayoutToolWindowControl(CodeLayoutToolWindowData data) : this()
        {
